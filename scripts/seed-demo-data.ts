...
async function seedDemoData() {
  ...
  const cropListings: CropListing[] = [
    ...
    },
    {
      ...
      status: 'sold',
      image: 'https://images.unsplash.com/photo-1615485500834-bc10199bc767?w=500',
    ...
    },
    {
      ...
      datePosted: new Date('2025-01-29'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1591708239426-8f29c354f46a?w=500',
      createdAt: new Date('2025-01-29'),
      updatedAt: new Date('2025-01-29'),
    },
    ...
    // Grace Akinyi's listings
    {
      ...
      status: 'available',
      image: 'https://images.unsplash.com/photo-1603052955121-ea21f78791db?w=500',
    ...
    },
    {
      ...
      datePosted: new Date('2025-02-03'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1606316080009-36884f7a7c4c?w=500',
      createdAt: new Date('2025-02-03'),
      updatedAt: new Date('2025-02-03'),
    },
    {
      ...
      datePosted: new Date('2025-02-01'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1625879560990-3d3c83e2e5f8?w=500',
      createdAt: new Date('2025-02-01'),
      updatedAt: new Date('2025-02-01'),
    },
    ...
    // James Mutua's listings (unverified)
    {
      ...
      datePosted: new Date('2025-02-02'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1617110570660-7e30fc3c7d42?w=500',
      createdAt: new Date('2025-02-02'),
      updatedAt: new Date('2025-02-02'),
    },
    {
      ...
      datePosted: new Date('2025-02-01'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1600655568096-2b9ecd1e2d3e?w=500',
      createdAt: new Date('2025-02-01'),
      updatedAt: new Date('2025-02-01'),
    },
    ...
    // Lucy Njeri's listings (unverified)
    {
      ...
      datePosted: new Date('2025-02-03'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1595855759920-86c3f0e7f63f?w=500',
      createdAt: new Date('2025-02-03'),
      updatedAt: new Date('2025-02-03'),
    },
    {
    ...
    },
    {
      ...
      datePosted: new Date('2025-02-03'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1589820296156-2454bb4a83e8?w=500',
      createdAt: new Date('2025-02-03'),
      updatedAt: new Date('2025-02-03'),
    },
    {
      ...
      datePosted: new Date('2025-02-02'),
      status: 'available',
      image: 'https://images.unsplash.com/photo-1568584711990-f424f3f1c05e?w=500',
      createdAt: new Date('2025-02-02'),
      updatedAt: new Date('2025-02-02'),
    },
  ];
